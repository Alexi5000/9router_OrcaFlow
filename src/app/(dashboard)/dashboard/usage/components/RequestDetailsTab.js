                  ...
                  (() => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="p-4 text-sm text-text-main">
                          <div className="flex flex-col gap-0.5">
                            <span className="font-mono">
                              {route.requestedModel || detail.model}
                            </span>
                            {routeSummary &&
                              routeSummary !==
                                (route.requestedModel || detail.model) && (
                        ...
                        <td className="p-4 text-sm text-text-main text-right font-mono">
                          {detail.tokens?.completion_tokens?.toLocaleString() ||
                            0}
                        </td>
        ...
        {selectedDetail &&
          (() => {
            const route = normalizeRequestRoute(selectedDetail.route, {
              requestedModel:
                selectedDetail.request?.model || selectedDetail.model,
              resolvedProvider: selectedDetail.provider,
              resolvedModel: selectedDetail.model,
              finalModel:
                selectedDetail.provider && selectedDetail.model
                  ? `${selectedDetail.provider}/${selectedDetail.model}`
                  : null,
            });
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="text-text-main font-mono">
                      {selectedDetail.tokens?.prompt_tokens?.toLocaleString() ||
                        0}
                    </span>
                  </div>
                  <div>
