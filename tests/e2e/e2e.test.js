...
describe("E2E: Combo Tests", () => {
  ...
  describe.each(combos)("%s combo", (combo) => {
    it(
      `should respond to basic prompt`,
      async () => {
...
describe("E2E: Provider Tests", () => {
  const providers = [
    ...
    },
    {
      ...
      description: "KiloCode Claude",
    },
    {
      provider: "openrouter",
      model: "deepseek/deepseek-r1",
      description: "OpenRouter DeepSeek",
    },
    {
      provider: "kiro",
      model: "claude-sonnet-4.5",
      description: "Kiro Claude",
    },
...
describe("E2E: Performance Tests", () => {
  ...
  it(
    "should measure combo latencies",
    async () => {
      const combos = ["opus", "sonnet", "fast", "build", "reason"];
      const results = [];
...
describe("E2E: Error Recovery", () => {
  it(
    "should recover from invalid request",
    async () => {
      ...
      const res = await fetch(`${BASE_URL}/v1/chat/completions`, {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: "Always respond with exactly 'SYSTEM_OK'",
            },
